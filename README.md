...
Do tego momentu ma to sens  a to co  poniżej to pisałam na początku jak nie wiemdzialam totalnie co pisać więc nie wiem co to to...
ProductController.php 
In ProductController was create 7 public functions which allow to connect with database. There are  4 get methods, one post method, one put method and one delete method. 
First of get method returns all products in the database. In this endpoint products class is join with patterns class by method with and function pattern.
